...
export const metadata = { title: "Admin · Nova vest", robots: { index: false } };

export default function NovaVest() {
  return (
    <div className="max-w-3xl">
      <Link href="/admin/vesti" className="text-sm text-bakar-700 hover:underline">
        ← Nazad
      </Link>
      <h1 className="mt-4 font-serif text-2xl font-bold text-sljiva-900">Nova vest</h1>
      {!isAdminConfigured() ? (
